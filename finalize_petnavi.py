#!/usr/bin/env python3
"""Finalize the PetNavi deck using the refiner's new source-material
cross-check (elevator_pitch + doc_text now threaded into finalize_refiner_prompt),
in addition to the existing spelling/typography/polish pass."""
